...
namespace Utage
{
	...
	public class AdvUguiMessageWindow : MonoBehaviour, IAdvMessageWindow, IAdvMessageWindowCaracterCountChecker
	{
		...
		//メニューボタンが押された
		public virtual void OnTapMenu()
		{
			Engine.UiManager.Status = AdvUiManager.UiStatus.Menu;
		}

		//インベントリボタンが押された
		public virtual void OnTapInventory()
		{
			Engine.UiManager.Status = AdvUiManager.UiStatus.Inventory;
		}
	}
